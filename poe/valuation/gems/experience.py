...
def xp_value(prices):
    ...
    analysis["profit_with_qual_bow"] = analysis.profit * analysis.gem_type.map(
        {"Awakened": 1, "normal": 1, "special": 2.00}
