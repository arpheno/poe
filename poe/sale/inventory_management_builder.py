...
from poe.sale.layouters.divine import DivineLayouter
...
def build_inventory_management(
    *,
    ...
    divine_value = prices["Divine Orb"][0]["chaosValue"]
    pricer = Pricer(price_base_by_type, price_base)
    layouter = DivineLayouter(divine_value=divine_value, min_trade_value=min_trade_value)
    seller = Seller(
